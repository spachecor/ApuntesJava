...
public class TestProtectora implements Buscable, Eliminable{
	public static void main(String[] args) {
		...
		System.out.println(animales.get(0).buscar(animales.get(0).getEstadosAnimal(), estado3));
		ts.eliminar(animales, ts.buscar(animales, animales.get(1)));
		//creamos un nuevo adoptante dentro del array de personas
		personas.add(new Adoptante("Maria Reyes", "12345678D", "ninguno", "a@a.com", "calle", "soleada", null, "izq", null, "Palma del Río", "Córdoba", 789654123, 105, 0, 14500, 15000, 65, 2));
